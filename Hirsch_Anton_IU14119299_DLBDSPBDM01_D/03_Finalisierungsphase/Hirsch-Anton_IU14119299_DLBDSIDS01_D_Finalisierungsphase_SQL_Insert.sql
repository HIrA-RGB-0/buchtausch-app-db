...
-- ======================================================================
-- ABGABEVERSION (Phase 3) – INSERTS mit Kommentaren zu Änderungen ggü. Phase 2
--
-- Relevante Änderungen gegenüber Phase 2, die die Inserts betreffen:
--   • ausleihe: Spalte verleiher_id entfällt – die Inserts nutzen nur noch
--               (exemplar_id, ausleiher_id, startdatum, enddatum, status).
--   • Status- und Defaults: Durch neue CHECKs/Defaults in Phase 3 bleiben
--       - Statuswerte (z. B. 'verfügbar', 'aktiv') unverändert gültig,
--       - bewertung.erstellt_am hat nun einen Default (hier weiterhin explizit gesetzt).
--
-- Hinweis: Die SQL-Statements selbst sind unverändert; es wurden nur erläuternde
--          Kommentare ergänzt, um die Unterschiede zu Phase 2 klar darzustellen.
-- ======================================================================
-- ========================================================
-- Projekt: Buchtausch-App – Phase 3 (Finalisierungsphase)
-- Datei: Hirsch-Anton_IU14119299_DLBDSIDS01-01_D_Finalisierungsphase_SQL_Insert.sql
-- Autor: Anton Hirsch | IU14119299
-- Beschreibung: Dummy-Daten für alle Tabellen (angepasst an FINAL-Schema)
-- WICHTIG: ausleihe hat KEIN verleiher_id mehr!
--          Status-Werte entsprechen den CHECK-Constraints.
-- DB: buchtausch_app (MariaDB/InnoDB, utf8mb4)
-- ========================================================

USE buchtausch_app;

-- Reset in FK-sicherer Reihenfolge
DELETE FROM chat_nachricht;      ALTER TABLE chat_nachricht AUTO_INCREMENT = 1;
DELETE FROM chat_thread;         ALTER TABLE chat_thread  AUTO_INCREMENT = 1;
DELETE FROM hilfe_ticket;        ALTER TABLE hilfe_ticket AUTO_INCREMENT = 1;

DELETE FROM bewertung;           ALTER TABLE bewertung    AUTO_INCREMENT = 1;
DELETE FROM reservierung;        ALTER TABLE reservierung AUTO_INCREMENT = 1;
DELETE FROM ausleihe;            ALTER TABLE ausleihe     AUTO_INCREMENT = 1;

DELETE FROM zeitfenster;         ALTER TABLE zeitfenster  AUTO_INCREMENT = 1;
DELETE FROM buch_exemplar;       ALTER TABLE buch_exemplar AUTO_INCREMENT = 1;
DELETE FROM abholort;            ALTER TABLE abholort     AUTO_INCREMENT = 1;
DELETE FROM zustand;             ALTER TABLE zustand      AUTO_INCREMENT = 1;

DELETE FROM werk_genre;          ALTER TABLE werk_genre   AUTO_INCREMENT = 1;
DELETE FROM werk_autor;          ALTER TABLE werk_autor   AUTO_INCREMENT = 1;
DELETE FROM buch_werk;           ALTER TABLE buch_werk    AUTO_INCREMENT = 1;
DELETE FROM genre;               ALTER TABLE genre        AUTO_INCREMENT = 1;
DELETE FROM autor;               ALTER TABLE autor        AUTO_INCREMENT = 1;
DELETE FROM verlag;              ALTER TABLE verlag       AUTO_INCREMENT = 1;

DELETE FROM admin;               ALTER TABLE admin        AUTO_INCREMENT = 1;
DELETE FROM verleiher;           ALTER TABLE verleiher    AUTO_INCREMENT = 1;
DELETE FROM ausleiher;           ALTER TABLE ausleiher    AUTO_INCREMENT = 1;
DELETE FROM benutzer;            ALTER TABLE benutzer     AUTO_INCREMENT = 1;

DELETE FROM adresse;             ALTER TABLE adresse      AUTO_INCREMENT = 1;
...
-- benutzer (20) – Status-Werte passen zum CHECK
...
-- abholort (12) – UNIQUE (verleiher, adresse, bezeichnung) wird eingehalten
...
-- zeitfenster (UNIQUE Slot + Zeit-Check erfüllt)
...
-- buch_exemplar – Status & max_ausleihdauer erfüllen CHECKs
...
-- ========================================================
-- Block D: Prozesse (Achtung: ausleihe OHNE verleiher_id!)
-- ========================================================

-- ausleihe (12) – jetzt: (exemplar_id, ausleiher_id, startdatum, enddatum, status)
-- [GEÄNDERT ggü. Phase 2: ausleihe jetzt ohne verleiher_id]
-- [GEÄNDERT ggü. Phase 2: verleiher_id entfällt]
INSERT INTO ausleihe (exemplar_id, ausleiher_id, startdatum, enddatum, status) VALUES
(1,   3,  '2025-07-01', '2025-07-20', 'abgeschlossen'),
(2,   4,  '2025-07-10', '2025-07-24', 'abgeschlossen'),
(3,   6,  '2025-08-01', '2025-08-22', 'aktiv'),
(4,   7,  '2025-07-15', '2025-07-29', 'abgeschlossen'),
(5,   8,  '2025-08-05', '2025-08-19', 'aktiv'),
(6,   9,  '2025-08-10', '2025-08-24', 'aktiv'),
(7,   11, '2025-07-05', '2025-07-19', 'abgeschlossen'),
(8,   12, '2025-08-12', '2025-08-26', 'aktiv'),
(9,   13, '2025-07-20', '2025-08-03', 'abgeschlossen'),
(10,  15, '2025-08-01', '2025-08-15', 'abgeschlossen'),
(11,  17, '2025-08-18', '2025-09-01', 'aktiv'),
(12,  18, '2025-08-22', '2025-09-05', 'aktiv');

-- reservierung (12) – Status-Werte passen
...
-- bewertung (12) – Defaults vorhanden, hier mit expliziten Zeiten
...
-- hilfe_ticket (10) – Status-Werte passen
